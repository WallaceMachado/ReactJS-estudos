...
//sobre os clicos de vidas dos componentes
class App extends Component{

    constructor(props){ //construtor é o primeiro a ser carregado
      super(props)
      this.state = { 
        hora: '00:00:00'
      };
    ...
    //componentDidMount é o segundo a ser carregado é só é executado uma vez quando a pagia carrega
    componentDidMount(){
        setInterval(()=>{this.setState({hora: new Date().toLocaleTimeString()})

        },1000); //fica exucutando algo apos de intevalo de tempo, nesse é um segundo
    }
   
    // é executado sempre que o componente state é atualizado
      componentDidUpdate(){
